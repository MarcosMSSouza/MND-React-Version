...
export const state = {
  ...
  playerDecks: {
    ...
    deck_3: {
      ...
      crs: [
        convertedMNDcards.garlak,
        convertedMNDcards.gransaber,
        convertedMNDcards.exposure,
        convertedMNDcards.sarf,
        convertedMNDcards.shattershards,
        convertedMNDcards.krenkrajak,
        convertedMNDcards.refract,
      ],
    },
    deck_4: {
      id: "deck_4",
