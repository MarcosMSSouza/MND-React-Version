...
export function useSoundDeckSelected() {
  let soundUrl = deckSelected;
  let [play] = useSound(soundUrl);
  play();
}

// const playHoveringSystemBtns = useHoveringSystemBtns;
export function useHoveringSystemBtns() {
...
// export function soundDeckSelected() {
//   const [play] = useSound(soundUrl);
//   play();
// }
